...
var rr = { exports: {} }, tr = { exports: {} }, ar = {}, Z = {}, mr;
function Or() {
  if (mr) return Z;
  mr = 1, Z.byteLength = o, Z.toByteArray = A, Z.fromByteArray = D;
  for (var h = [], f = [], y = typeof Uint8Array < "u" ? Uint8Array : Array, d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", w = 0, x = d.length; w < x; ++w)
    h[w] = d[w], f[d.charCodeAt(w)] = w;
  f[45] = 62, f[95] = 63;
  function a(c) {
    var l = c.length;
    if (l % 4 > 0)
  ...
  function A(c) {
    var l, p = a(c), I = p[0], P = p[1], S = new y(m(c, I, P)), M = 0, O = P > 0 ? I - 4 : I, F;
    for (F = 0; F < O; F += 4)
      l = f[c.charCodeAt(F)] << 18 | f[c.charCodeAt(F + 1)] << 12 | f[c.charCodeAt(F + 2)] << 6 | f[c.charCodeAt(F + 3)], S[M++] = l >> 16 & 255, S[M++] = l >> 8 & 255, S[M++] = l & 255;
    return P === 2 && (l = f[c.charCodeAt(F)] << 2 | f[c.charCodeAt(F + 1)] >> 4, S[M++] = l & 255), P === 1 && (l = f[c.charCodeAt(F)] << 10 | f[c.charCodeAt(F + 1)] << 4 | f[c.charCodeAt(F + 2)] >> 2, S[M++] = l >> 8 & 255, S[M++] = l & 255), S;
  }
  function b(c) {
    return h[c >> 18 & 63] + h[c >> 12 & 63] + h[c >> 6 & 63] + h[c & 63];
  }
  function T(c, l, p) {
    for (var I, P = [], S = l; S < p; S += 3)
      I = (c[S] << 16 & 16711680) + (c[S + 1] << 8 & 65280) + (c[S + 2] & 255), P.push(b(I));
    return P.join("");
  }
  function D(c) {
    for (var l, p = c.length, I = p % 3, P = [], S = 16383, M = 0, O = p - I; M < O; M += S)
      P.push(T(c, M, M + S > O ? O : M + S));
    return I === 1 ? (l = c[p - 1], P.push(
      h[l >> 2] + h[l << 4 & 63] + "=="
    )) : I === 2 && (l = (c[p - 2] << 8) + c[p - 1], P.push(
...
var Er;
function $r() {
  return Er || (Er = 1, er.read = function(h, f, y, d, w) {
    var x, a, o = w * 8 - d - 1, m = (1 << o) - 1, A = m >> 1, b = -7, T = y ? w - 1 : 0, D = y ? -1 : 1, c = h[f + T];
    for (T += D, x = c & (1 << -b) - 1, c >>= -b, b += o; b > 0; x = x * 256 + h[f + T], T += D, b -= 8)
      ;
    for (a = x & (1 << -b) - 1, x >>= -b, b += d; b > 0; a = a * 256 + h[f + T], T += D, b -= 8)
      ;
    if (x === 0)
      x = 1 - A;
    else {
      ...
      a = a + Math.pow(2, d), x = x - A;
    }
    return (c ? -1 : 1) * a * Math.pow(2, x - d);
  }, er.write = function(h, f, y, d, w, x) {
    var a, o, m, A = x * 8 - w - 1, b = (1 << A) - 1, T = b >> 1, D = w === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, c = d ? 0 : x - 1, l = d ? 1 : -1, p = f < 0 || f === 0 && 1 / f < 0 ? 1 : 0;
    for (f = Math.abs(f), isNaN(f) || f === 1 / 0 ? (o = isNaN(f) ? 1 : 0, a = b) : (a = Math.floor(Math.log(f) / Math.LN2), f * (m = Math.pow(2, -a)) < 1 && (a--, m *= 2), a + T >= 1 ? f += D / m : f += D * Math.pow(2, 1 - T), f * m >= 2 && (a++, m /= 2), a + T >= b ? (o = 0, a = b) : a + T >= 1 ? (o = (f * m - 1) * Math.pow(2, w), a = a + T) : (o = f * Math.pow(2, T - 1) * Math.pow(2, w), a = 0)); w >= 8; h[y + c] = o & 255, c += l, o /= 256, w -= 8)
      ;
    for (a = a << w | o, A += w; A > 0; h[y + c] = a & 255, c += l, a /= 256, A -= 8)
      ;
    h[y + c - l] |= p * 128;
  }), er;
}
...
var Ir;
function Wr() {
  return Ir || (Ir = 1, (function(h) {
    const f = Or(), y = $r(), d = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
    h.Buffer = o, h.SlowBuffer = S, h.INSPECT_MAX_BYTES = 50;
    const w = 2147483647;
    h.kMaxLength = w, o.TYPED_ARRAY_SUPPORT = x(), !o.TYPED_ARRAY_SUPPORT && typeof console < "u" && typeof console.error == "function" && console.error(
    ...
    function b(e, r, t) {
      return A(e), e <= 0 ? a(e) : r !== void 0 ? typeof t == "string" ? a(e).fill(r, t) : a(e).fill(r) : a(e);
    }
    o.alloc = function(e, r, t) {
      return b(e, r, t);
    };
    function T(e) {
      return A(e), a(e < 0 ? 0 : P(e) | 0);
    }
    ...
    function c(e) {
      const r = e.length < 0 ? 0 : P(e.length) | 0, t = a(r);
      for (let n = 0; n < r; n += 1)
        t[n] = e[n] & 255;
      return t;
    }
    ...
    function I(e) {
      if (o.isBuffer(e)) {
        const r = P(e.length) | 0, t = a(r);
        return t.length === 0 || e.copy(t, 0, 0, r), t;
      }
      if (e.length !== void 0)
        return typeof e.length != "number" || sr(e.length) ? a(0) : c(e);
    ...
    o.isBuffer = function(r) {
      ...
      if (W(r, Uint8Array) && (r = o.from(r, r.offset, r.byteLength)), W(t, Uint8Array) && (t = o.from(t, t.offset, t.byteLength)), !o.isBuffer(r) || !o.isBuffer(t))
        throw new TypeError(
    ...
    o.prototype.swap16 = function() {
      ...
      const r = this.length;
      return r === 0 ? "" : arguments.length === 0 ? k(this, 0, r) : O.apply(this, arguments);
    ...
    }, d && (o.prototype[d] = o.prototype.inspect), o.prototype.compare = function(r, t, n, i, u) {
      if (W(r, Uint8Array) && (r = o.from(r, r.offset, r.byteLength)), !o.isBuffer(r))
        throw new TypeError(
      ...
      let s = u - i, B = n - t;
      const _ = Math.min(s, B), U = this.slice(i, u), C = r.slice(t, n);
      for (let E = 0; E < _; ++E)
        if (U[E] !== C[E]) {
          s = U[E], B = C[E];
          break;
    ...
    function z(e, r, t, n, i) {
      ...
      if (typeof t == "string" ? (n = t, t = 0) : t > 2147483647 ? t = 2147483647 : t < -2147483648 && (t = -2147483648), t = +t, sr(t) && (t = i ? 0 : e.length - 1), t < 0 && (t = e.length + t), t >= e.length) {
        if (i) return -1;
        t = e.length - 1;
      } else if (t < 0)
        if (i) t = 0;
      ...
      if (typeof r == "string" && (r = o.from(r, n)), o.isBuffer(r))
        return r.length === 0 ? -1 : V(e, r, t, n, i);
      if (typeof r == "number")
        return r = r & 255, typeof Uint8Array.prototype.indexOf == "function" ? i ? Uint8Array.prototype.indexOf.call(e, r, t) : Uint8Array.prototype.lastIndexOf.call(e, r, t) : V(e, [r], t, n, i);
      throw new TypeError("val must be string, number or Buffer");
    }
    function V(e, r, t, n, i) {
      let u = 1, s = e.length, B = r.length;
      ...
      function _(C, E) {
        return u === 1 ? C[E] : C.readUInt16BE(E * u);
      }
      let U;
      if (i) {
        let C = -1;
        for (U = t; U < s; U++)
          if (_(e, U) === _(r, C === -1 ? 0 : U - C)) {
            if (C === -1 && (C = U), U - C + 1 === B) return C * u;
          } else
            C !== -1 && (U -= U - C), C = -1;
      } else
        for (t + B > s && (t = s - B), U = t; U >= 0; U--) {
          let C = !0;
          for (let E = 0; E < B; E++)
            if (_(e, U + E) !== _(r, E)) {
              C = !1;
    ...
    function Y(e, r, t, n) {
      ...
      let s;
      for (s = 0; s < n; ++s) {
        const B = parseInt(r.substr(s * 2, 2), 16);
        if (sr(B)) return s;
        e[t + s] = B;
      }
      return s;
    ...
    function k(e, r, t) {
      ...
      for (; i < t; ) {
        const u = e[i];
        let s = null, B = u > 239 ? 4 : u > 223 ? 3 : u > 191 ? 2 : 1;
        if (i + B <= t) {
          let _, U, C, E;
          switch (B) {
            case 1:
              ...
              break;
            case 2:
              _ = e[i + 1], (_ & 192) === 128 && (E = (u & 31) << 6 | _ & 63, E > 127 && (s = E));
              break;
            case 3:
              _ = e[i + 1], U = e[i + 2], (_ & 192) === 128 && (U & 192) === 128 && (E = (u & 15) << 12 | (_ & 63) << 6 | U & 63, E > 2047 && (E < 55296 || E > 57343) && (s = E));
              break;
            case 4:
              _ = e[i + 1], U = e[i + 2], C = e[i + 3], (_ & 192) === 128 && (U & 192) === 128 && (C & 192) === 128 && (E = (u & 15) << 18 | (_ & 63) << 12 | (U & 63) << 6 | C & 63, E > 65535 && E < 1114112 && (s = E));
          }
        }
    ...
    o.prototype.readUintLE = o.prototype.readUIntLE = function(r, t, n) {
      r = r >>> 0, t = t >>> 0, n || N(r, t, this.length);
      let i = this[r], u = 1, s = 0;
      for (; ++s < t && (u *= 256); )
        i += this[r + s] * u;
      return i;
      ...
      return r = r >>> 0, t || N(r, 1, this.length), this[r];
    }, o.prototype.readUint16LE = o.prototype.readUInt16LE = function(r, t) {
      return r = r >>> 0, t || N(r, 2, this.length), this[r] | this[r + 1] << 8;
    }, o.prototype.readUint16BE = o.prototype.readUInt16BE = function(r, t) {
      return r = r >>> 0, t || N(r, 2, this.length), this[r] << 8 | this[r + 1];
    }, o.prototype.readUint32LE = o.prototype.readUInt32LE = function(r, t) {
      return r = r >>> 0, t || N(r, 4, this.length), (this[r] | this[r + 1] << 8 | this[r + 2] << 16) + this[r + 3] * 16777216;
    }, o.prototype.readUint32BE = o.prototype.readUInt32BE = function(r, t) {
      return r = r >>> 0, t || N(r, 4, this.length), this[r] * 16777216 + (this[r + 1] << 16 | this[r + 2] << 8 | this[r + 3]);
    }, o.prototype.readBigUInt64LE = G(function(r) {
      r = r >>> 0, J(r, "offset");
    ...
    }), o.prototype.readBigUInt64BE = G(function(r) {
      r = r >>> 0, J(r, "offset");
      const t = this[r], n = this[r + 7];
      (t === void 0 || n === void 0) && K(r, this.length - 8);
      ...
      r = r >>> 0, t = t >>> 0, n || N(r, t, this.length);
      let i = t, u = 1, s = this[r + --i];
      for (; i > 0 && (u *= 256); )
        s += this[r + --i] * u;
      return u *= 128, s >= u && (s -= Math.pow(2, 8 * t)), s;
    }, o.prototype.readInt8 = function(r, t) {
      return r = r >>> 0, t || N(r, 1, this.length), this[r] & 128 ? (255 - this[r] + 1) * -1 : this[r];
    }, o.prototype.readInt16LE = function(r, t) {
      r = r >>> 0, t || N(r, 2, this.length);
      ...
      return r = r >>> 0, t || N(r, 4, this.length), this[r] | this[r + 1] << 8 | this[r + 2] << 16 | this[r + 3] << 24;
    }, o.prototype.readInt32BE = function(r, t) {
      return r = r >>> 0, t || N(r, 4, this.length), this[r] << 24 | this[r + 1] << 16 | this[r + 2] << 8 | this[r + 3];
    }, o.prototype.readBigInt64LE = G(function(r) {
      r = r >>> 0, J(r, "offset");
      const t = this[r], n = this[r + 7];
      (t === void 0 || n === void 0) && K(r, this.length - 8);
      const i = this[r + 4] + this[r + 5] * 2 ** 8 + this[r + 6] * 2 ** 16 + (n << 24);
      return (BigInt(i) << BigInt(32)) + BigInt(t + this[++r] * 2 ** 8 + this[++r] * 2 ** 16 + this[++r] * 2 ** 24);
    }), o.prototype.readBigInt64BE = G(function(r) {
      r = r >>> 0, J(r, "offset");
      const t = this[r], n = this[r + 7];
      (t === void 0 || n === void 0) && K(r, this.length - 8);
      ...
      return r = r >>> 0, t || N(r, 4, this.length), y.read(this, r, !0, 23, 4);
    }, o.prototype.readFloatBE = function(r, t) {
      return r = r >>> 0, t || N(r, 4, this.length), y.read(this, r, !1, 23, 4);
    }, o.prototype.readDoubleLE = function(r, t) {
      return r = r >>> 0, t || N(r, 8, this.length), y.read(this, r, !0, 52, 8);
    }, o.prototype.readDoubleBE = function(r, t) {
      return r = r >>> 0, t || N(r, 8, this.length), y.read(this, r, !1, 52, 8);
    };
    function L(e, r, t, n, i, u) {
    ...
    o.prototype.writeUintLE = o.prototype.writeUIntLE = function(r, t, n, i) {
      ...
      let u = n - 1, s = 1;
      for (this[t + u] = r & 255; --u >= 0 && (s *= 256); )
        this[t + u] = r / s & 255;
      return t + n;
    }, o.prototype.writeUint8 = o.prototype.writeUInt8 = function(r, t, n) {
      return r = +r, t = t >>> 0, n || L(this, r, t, 1, 255, 0), this[t] = r & 255, t + 1;
    }, o.prototype.writeUint16LE = o.prototype.writeUInt16LE = function(r, t, n) {
      return r = +r, t = t >>> 0, n || L(this, r, t, 2, 65535, 0), this[t] = r & 255, this[t + 1] = r >>> 8, t + 2;
    }, o.prototype.writeUint16BE = o.prototype.writeUInt16BE = function(r, t, n) {
      return r = +r, t = t >>> 0, n || L(this, r, t, 2, 65535, 0), this[t] = r >>> 8, this[t + 1] = r & 255, t + 2;
    }, o.prototype.writeUint32LE = o.prototype.writeUInt32LE = function(r, t, n) {
      return r = +r, t = t >>> 0, n || L(this, r, t, 4, 4294967295, 0), this[t + 3] = r >>> 24, this[t + 2] = r >>> 16, this[t + 1] = r >>> 8, this[t] = r & 255, t + 4;
    }, o.prototype.writeUint32BE = o.prototype.writeUInt32BE = function(r, t, n) {
      return r = +r, t = t >>> 0, n || L(this, r, t, 4, 4294967295, 0), this[t] = r >>> 24, this[t + 1] = r >>> 16, this[t + 2] = r >>> 8, this[t + 3] = r & 255, t + 4;
    };
    ...
    o.prototype.writeBigUInt64LE = G(function(r, t = 0) {
      return hr(this, r, t, BigInt(0), BigInt("0xffffffffffffffff"));
    }), o.prototype.writeBigUInt64BE = G(function(r, t = 0) {
      ...
      let u = 0, s = 1, B = 0;
      for (this[t] = r & 255; ++u < n && (s *= 256); )
        r < 0 && B === 0 && this[t + u - 1] !== 0 && (B = 1), this[t + u] = (r / s >> 0) - B & 255;
      return t + n;
      ...
      return r = +r, t = t >>> 0, n || L(this, r, t, 1, 127, -128), r < 0 && (r = 255 + r + 1), this[t] = r & 255, t + 1;
    }, o.prototype.writeInt16LE = function(r, t, n) {
      return r = +r, t = t >>> 0, n || L(this, r, t, 2, 32767, -32768), this[t] = r & 255, this[t + 1] = r >>> 8, t + 2;
    }, o.prototype.writeInt16BE = function(r, t, n) {
      return r = +r, t = t >>> 0, n || L(this, r, t, 2, 32767, -32768), this[t] = r >>> 8, this[t + 1] = r & 255, t + 2;
    }, o.prototype.writeInt32LE = function(r, t, n) {
      return r = +r, t = t >>> 0, n || L(this, r, t, 4, 2147483647, -2147483648), this[t] = r & 255, this[t + 1] = r >>> 8, this[t + 2] = r >>> 16, this[t + 3] = r >>> 24, t + 4;
    }, o.prototype.writeInt32BE = function(r, t, n) {
      return r = +r, t = t >>> 0, n || L(this, r, t, 4, 2147483647, -2147483648), r < 0 && (r = 4294967295 + r + 1), this[t] = r >>> 24, this[t + 1] = r >>> 16, this[t + 2] = r >>> 8, this[t + 3] = r & 255, t + 4;
    }, o.prototype.writeBigInt64LE = G(function(r, t = 0) {
      return hr(this, r, t, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"));
    }), o.prototype.writeBigInt64BE = G(function(r, t = 0) {
    ...
    o.prototype.writeDoubleLE = function(r, t, n) {
      ...
      if (typeof r == "number")
        ...
        const s = o.isBuffer(r) ? r : o.from(r, i), B = s.length;
        if (B === 0)
    ...
    function br(e, r, t) {
      J(r, "offset"), (e[r] === void 0 || e[r + t] === void 0) && K(r, e.length - (t + 1));
    }
    function gr(e, r, t, n, i, u) {
      if (e > t || e < r) {
        const s = typeof r == "bigint" ? "n" : "";
        let B;
        throw r === 0 || r === BigInt(0) ? B = `>= 0${s} and < 2${s} ** ${(u + 1) * 8}${s}` : B = `>= -(2${s} ** ${(u + 1) * 8 - 1}${s}) and < 2 ** ${(u + 1) * 8 - 1}${s}`, new j.ERR_OUT_OF_RANGE("value", B, e);
      }
      br(n, i, u);
    }
    function J(e, r) {
      if (typeof e != "number")
        throw new j.ERR_INVALID_ARG_TYPE(r, "number", e);
    }
    function K(e, r, t) {
      throw Math.floor(e) !== e ? (J(e, t), new j.ERR_OUT_OF_RANGE("offset", "an integer", e)) : r < 0 ? new j.ERR_BUFFER_OUT_OF_BOUNDS() : new j.ERR_OUT_OF_RANGE(
        "offset",
        `>= 0 and <= ${r}`,
        e
      );
    ...
    function Mr(e, r) {
      ...
      for (let s = 0; s < e.length && !((r -= 2) < 0); ++s)
        t = e.charCodeAt(s), n = t >> 8, i = t % 256, u.push(i), u.push(n);
      return u;
    }
    function Br(e) {
...
var Fr;
function qr() {
  return Fr || (Fr = 1, (function(h, f) {
    var y = Wr(), d = y.Buffer;
    function w(a, o) {
      for (var m in a)
        o[m] = a[m];
    }
    d.from && d.alloc && d.allocUnsafe && d.allocUnsafeSlow ? h.exports = y : (w(y, f), f.Buffer = x);
    function x(a, o, m) {
      return d(a, o, m);
    }
    x.prototype = Object.create(d.prototype), w(d, x), x.from = function(a, o, m) {
      if (typeof a == "number")
        throw new TypeError("Argument must not be a number");
      return d(a, o, m);
    }, x.alloc = function(a, o, m) {
      if (typeof a != "number")
        throw new TypeError("Argument must be a number");
      var A = d(a);
      return o !== void 0 ? typeof m == "string" ? A.fill(o, m) : A.fill(o) : A.fill(0), A;
      ...
      if (typeof a != "number")
        throw new TypeError("Argument must be a number");
      return y.SlowBuffer(a);
    };
  })(tr, tr.exports)), tr.exports;
}
var Ar;
function Gr() {
  if (Ar) return rr.exports;
  Ar = 1;
  var h = 65536, f = 4294967295;
  function y() {
    throw new Error(`Secure random number generation is not supported by this browser.
Use Chrome, Firefox or Internet Explorer 11`);
  }
  var d = qr().Buffer, w = xr.crypto || xr.msCrypto;
  w && w.getRandomValues ? rr.exports = x : rr.exports = y;
  function x(a, o) {
    if (a > f) throw new RangeError("requested too many random bytes");
    var m = d.allocUnsafe(a);
    if (a > 0)
      if (a > h)
        for (var A = 0; A < a; A += h)
          w.getRandomValues(m.slice(A, A + h));
      else
        w.getRandomValues(m);
...
function Hr() {
  if (Ur) return fr;
  Ur = 1;
  var h = Gr(), f = 16, y = T(), d = new RegExp('(\\\\)?"@__(F|R|D|M|S|A|U|I|B|L)-' + y + '-(\\d+)__@"', "g"), w = /\{\s*\[native code\]\s*\}/g, x = /function.*?\(/, a = /.*?=>.*?/, o = /[<>\/\u2028\u2029]/g, m = ["*", "async"], A = {
    "<": "\\u003C",
    ">": "\\u003E",
    "/": "\\u002F",
    "\u2028": "\\u2028",
  ...
  function D(c) {
    var l = [];
    for (var p in c)
      typeof c[p] == "function" && l.push(p);
    for (var I = 0; I < l.length; I++)
      delete c[l[I]];
  }
  return fr = function c(l, p) {
    p || (p = {}), (typeof p == "number" || typeof p == "string") && (p = { space: p });
    var I = [], P = [], S = [], M = [], O = [], F = [], z = [], V = [], Y = [], X = [];
    function nr(q, k) {
      if (p.ignoreFunction && D(k), !k && k !== void 0 && k !== BigInt(0))
        return k;
      var g = this[q], R = typeof g;
      if (R === "object") {
        if (g instanceof RegExp)
          return "@__R-" + y + "-" + (P.push(g) - 1) + "__@";
        if (g instanceof Date)
          return "@__D-" + y + "-" + (S.push(g) - 1) + "__@";
        if (g instanceof Map)
          return "@__M-" + y + "-" + (M.push(g) - 1) + "__@";
        if (g instanceof Set)
          return "@__S-" + y + "-" + (O.push(g) - 1) + "__@";
        if (g instanceof Array) {
          var H = g.filter(function() {
            return !0;
          }).length !== g.length;
          if (H)
        ...
        if (g instanceof URL)
          return "@__L-" + y + "-" + (X.push(g) - 1) + "__@";
      }
      return R === "function" ? "@__F-" + y + "-" + (I.push(g) - 1) + "__@" : R === "undefined" ? "@__U-" + y + "-" + (z.push(g) - 1) + "__@" : R === "number" && !isNaN(g) && !isFinite(g) ? "@__I-" + y + "-" + (V.push(g) - 1) + "__@" : R === "bigint" ? "@__B-" + y + "-" + (Y.push(g) - 1) + "__@" : k;
    }
    function ir(q) {
      var k = q.toString();
      if (w.test(k))
        throw new TypeError("Serializing native function: " + q.name);
      if (x.test(k) || a.test(k))
        return k;
      var g = k.indexOf("("), R = k.substr(0, g).trim().split(" ").filter(function(v) {
        return v.length > 0;
      }), H = R.filter(function(v) {
        return m.indexOf(v) === -1;
      });
      return H.length > 0 ? (R.indexOf("async") > -1 ? "async " : "") + "function" + (R.join("").indexOf("*") > -1 ? "*" : "") + k.substr(g) : k;
    }
    if (p.ignoreFunction && typeof l == "function" && (l = void 0), l === void 0)
      return String(l);
    var $;
    return p.isJSON && !p.space ? $ = JSON.stringify(l) : $ = JSON.stringify(l, p.isJSON ? null : nr, p.space), typeof $ != "string" ? String($) : (p.unsafe !== !0 && ($ = $.replace(o, b)), I.length === 0 && P.length === 0 && S.length === 0 && M.length === 0 && O.length === 0 && F.length === 0 && z.length === 0 && V.length === 0 && Y.length === 0 && X.length === 0 ? $ : $.replace(d, function(q, k, g, R) {
      if (k)
        return q;
      if (g === "D")
        return 'new Date("' + S[R].toISOString() + '")';
      if (g === "R")
        return "new RegExp(" + c(P[R].source) + ', "' + P[R].flags + '")';
      if (g === "M")
        return "new Map(" + c(Array.from(M[R].entries()), p) + ")";
      if (g === "S")
        return "new Set(" + c(Array.from(O[R].values()), p) + ")";
      if (g === "A")
        return "Array.prototype.slice.call(" + c(Object.assign({ length: F[R].length }, F[R]), p) + ")";
      if (g === "U")
        return "undefined";
      if (g === "I")
        return V[R];
      if (g === "B")
        return 'BigInt("' + Y[R] + '")';
      if (g === "L")
        return "new URL(" + c(X[R].toString(), p) + ")";
      var H = I[R];
      return ir(H);
    }));
  }, fr;
...
var Vr = Hr();
const jr = /* @__PURE__ */ Dr(Vr), Rr = "sanity:client", Sr = "\0" + Rr;
function Jr(h) {
  return {
    name: "sanity:client",
    resolveId(f) {
...
function cr(h) {
  const f = h == null ? void 0 : h.replace(/^\/+|\/+$/g, "");
  return f ? `/${f}` : void 0;
}
function zr(h, f) {
  const y = cr(h);
  if (y)
    return f === "hash" ? y : `${y}/[...params]`;
}
function Yr(h) {
  const f = "sanity:studio", y = f;
  return {
    name: "sanity:studio",
    resolveId(d) {
      return d === f ? y : null;
    ...
    async load(d) {
      if (d === f) {
        ...
        const x = cr(h.studioBasePath);
        if (!x)
          throw new Error(
            "[@sanity/astro]: The `studioBasePath` option cannot be empty. For example — `studioBasePath: '/admin'`"
          );
        const a = h.studioRouterHistory === "hash" ? "hash" : "browser";
        return `
        import studioConfig from "${w.id}";

        const embeddedStudioBasePath = "${x}";
        const historyMode = "${a}";
...
function Xr() {
  const h = "sanity:studio-hash-router", f = h;
  return {
    ...
    async load(y) {
      if (y === h) {
        ...
        return `export {default} from "${d.id}";`;
      }
      return null;
    }
  };
...
function Zr(h = {}) {
  const f = h.studioBasePath, y = cr(f), d = h.studioRouterHistory === "hash" ? "hash" : "browser", w = h;
  if (delete w.studioBasePath, delete w.studioRouterHistory, f && f.match(/https?:\/\//))
    throw new Error(
  ...
  return {
    name: "@sanity/astro",
    hooks: {
      "astro:config:setup": ({ injectScript: x, injectRoute: a, updateConfig: o }) => {
        o({
          vite: {
            optimizeDeps: {
              include: [
